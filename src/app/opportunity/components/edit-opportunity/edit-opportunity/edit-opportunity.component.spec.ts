...
class MockAPIService {
  ...
  constructor() {
    ...
    this.data['/JobDescription/31'] = {"jobDescription":{"id":31,"profile":2,"location":5,"employmentType":2,"hiringManager":4,"openings":6,"postedOn":1590949800000,"postedBy":1,"lastUpdated":1591122600000,"lastUpdatedBy":0,"description":"Really Awesome Job"},"skillList":[1,3,8,11,10,2]};
...
describe('EditOpportunityComponent', () => {
  ...
  it('should reset form', () => {
    component.resetForm();
    expect(component.jobId).toBe(31);
  });
